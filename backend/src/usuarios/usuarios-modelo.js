...
class Usuario {
    ...
    async adicionaSenha(senha) {
        ...
        validacoes.campoTamanhoMinimo(senha, 'senha', 6);
        validacoes.campoTamanhoMaximo(senha, 'senha', 64);
        validacoes.campoLetraMinuscula(senha, 'senha');
        validacoes.campoLetraMaiuscula(senha, 'senha');
        validacoes.campoNumero(senha, 'senha');
